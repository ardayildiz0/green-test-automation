 ...
 */
export async function createDocxReport(outputPath, institutionName, url, coldResults, warmResults, lhResults, screenshotPath, authorName, advisorName, reportDate) {
  // Template'i oku
...
function trimCoverEmptyParagraphs(xml) {
  // Boş paragraf pattern'i — kapak sayfasındaki rsidP="00023833" sabitiyle
...
function replaceSectionText(xml, sectionId, newText, coldGrade = null, warmGrade = null, coldResults = null, warmResults = null) {
  ...
  if (sectionId === 'ÖZET' && coldGrade && warmGrade) {
    ...
    const getGradeDrawingXml = (grade, label) => {
      const rId = GRADE_RIDS[grade];
      if (!rId) return '';
      return `
        <w:p w14:paraId="${randomParaId()}" w14:textId="${randomParaId()}" w:rsidR="00530778" w:rsidRDefault="00530778">
          <w:pPr><w:spacing w:before="300" w:after="100"/><w:jc w:val="center"/><w:rPr><w:b/></w:rPr></w:pPr>
          <w:r><w:rPr><w:b/></w:rPr><w:t>${escXml(label)}</w:t></w:r>
        </w:p>
        <w:p w14:paraId="${randomParaId()}" w14:textId="${randomParaId()}" w:rsidR="00530778" w:rsidRDefault="00530778">
    ...
    // ─── Cold Cache Sonucu ───
    newContent += getGradeDrawingXml(coldGrade, 'Cold Cache Sonucu');
  ...
  while ((match = tblRegex.exec(xml)) !== null) {
    ...
    <w:p w14:paraId="${randomParaId()}" w14:textId="${randomParaId()}" w:rsidR="00530778" w:rsidRDefault="00530778">
      ...
      <w:r><w:br w:type="page"/></w:r>
        ...
        <w:p w14:paraId="${randomParaId()}" w14:textId="${randomParaId()}" w:rsidR="00530778" w:rsidRDefault="00530778">
          <w:pPr><w:spacing w:before="300" w:after="100"/><w:jc w:val="center"/><w:rPr><w:b/></w:rPr></w:pPr>
          <w:r><w:rPr><w:b/></w:rPr><w:t>Warm Cache Sonucu</w:t></w:r>
        </w:p>
        <w:p w14:paraId="${randomParaId()}" w14:textId="${randomParaId()}" w:rsidR="00530778" w:rsidRDefault="00530778">
          <w:pPr><w:jc w:val="center"/></w:pPr>
          <w:r>
