...
export async function createDocxReport(outputPath, institutionName, url, coldResults, warmResults, lhResults, screenshotPath, authorName) {
  ...
  // ═══════════════════════════════════════
  docXml = replaceSectionText(docXml, 'ÖZET', texts.ozet, texts.coldGrade, texts.warmGrade);
 ...
 */
function replaceSectionText(xml, sectionId, newText, coldGrade = null, warmGrade = null) {
  // Bölüm başlığını bul
  let headingPattern;
  if (sectionId === 'ÖZET') {
